...
export const OurClientDiv = styled.div`
display: inline-flex;
flex-direction: column;
align-items: center;
background: white;
border-bottom: 1px solid #1D2E88;
border-top: 1px solid #1D2E88;
width: 100%;
margin: 14vw 0;
padding: 8vw 0;
`;

export const ClientHeading1 = styled.p`
text-align: center;
color: #828282;
font-weight: 400;
...
export const ClientHeading2 = styled.h1`
...
export const FirstImagesdiv = styled.div`
display: flex;
justify-content: center;
align-items: center;
...
export const SecondImagesdiv = styled.div`
display: flex;
justify-content: center;
align-items: center;
column-gap: clamp(1rem, 7vw, 10rem);
